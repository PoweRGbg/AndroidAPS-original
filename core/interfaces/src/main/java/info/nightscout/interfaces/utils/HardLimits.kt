...
interface HardLimits {
    companion object {
        ...
        val VERY_HARD_LIMIT_TEMP_MIN_BG = intArrayOf(60, 180)
        val VERY_HARD_LIMIT_TEMP_MAX_BG = intArrayOf(60, 270)
        val VERY_HARD_LIMIT_TEMP_TARGET_BG = intArrayOf(60, 200)
